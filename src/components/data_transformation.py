...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            categorical_columns = ['Commodity Code', 'Item Description', 'Project Name', 'Greenfield/ Brownfield', 'Client', 'Market Sector/Industry', 'Delivery Method', 'Item Type', 'coordinates', 'state', 'city', 'suburb']
            ...
            input_feature_train_df[categorical_columns] = target_encoder.fit_transform(input_feature_train_df[categorical_columns],target_feature_train_df)
            input_feature_test_df[categorical_columns] = target_encoder.transform(input_feature_test_df[categorical_columns])
